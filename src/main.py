...
def main() -> None:
    """
    Run the end-to-end pipeline: load data, clean and enrich it, analyze correlations
    and a simple regression, generate plots, and export results.
    """
    ...
    print_time_range(df)
    print_uniques(df)
    print("\nNote: See unique values and time range output above for years/months.")
